...
class Profissionalizante(models.Model):
    id = models.AutoField(primary_key=True)
    imagem = models.ImageField(upload_to='profissionalizante/img', blank=True)
...
class Customer(models.Model):
    ...
    IdProfissionalizante = models.ForeignKey(Profissionalizante, on_delete=models.CASCADE, verbose_name='ESCOLHA O CURSO QUE VOCÊ DESEJA CURSAR', null=True)
